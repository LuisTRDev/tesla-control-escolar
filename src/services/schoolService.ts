...
function mapPresentation(row: DbPresentation): PresentationRecord {
  ...
  return {
    ...
    lateEntryViolation: types.has('LATE_ENTRY'),
    inappropriateConductViolation: types.has('INAPPROPRIATE_CONDUCT'),
    // Reutilizamos other_description como descripción general para no migrar
    // presentation_controls y conservar compatibilidad con registros anteriores.
