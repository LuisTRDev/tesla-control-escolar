...
import {
  BarChart3, Bell, CalendarCheck2, CalendarDays, DatabaseBackup, Download, FileText, Home,
  LogOut, RotateCcw, Settings, ShieldCheck, Wifi, WifiOff, X, Zap,
} from 'lucide-react'

export type SidebarSection = 'home' | 'dashboard' | 'reports' | 'alerts' | 'summary' | 'audit' | 'quick' | 'backup'
...
type Props = {
  ...
  onBackups: () => void; onSettings: () => void; onResetToday: () => void; onLogout: () => void
...
export default function Sidebar({open,onClose,userName,userRole,formattedDate,onHome,onDashboard,onReports,onNotifications,onAlerts,onDailySummary,onAudit,onQuickMode,onBackups,onSettings,onResetToday,onLogout,online,pendingSync,active='home'}:Props){
